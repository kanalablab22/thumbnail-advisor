...
CRITERIA_INFO = {
    ...
    "background": {
        ...
        "ref_score": 5,
        "advice": {
            1: {"p": "medium", "t": "背景の要素が多めです", "d": "背景に多くの要素が検出されました。スタイリング写真であれば問題ありません。商品が一番目立っているか確認しましょう。なお枠線は楽天ガイドラインで禁止されています"},
            2: {"p": "medium", "t": "背景の情報量を確認する", "d": "背景にやや要素が多いかもしれません。スタイリング小物は商品を引き立てる程度に。全商品で同じ雰囲気に揃えるとブランド感が出ます"},
    ...
    "photo_quality": {
        ...
        "advice": {
            ...
            2: {"p": "medium", "t": "ライティングを改善", "d": "直射光を避けてディフューズ光（柔らかい光）で撮影。自然光＋レフ板で素材本来の質感が伝わる仕上がりに"},
